    ...
    const fetchData = async () => {
      try {
        const [restaurantRes, menuRes] = await Promise.all([
          axios.get(`http://localhost:5003/api/restaurants/${id}`),
          axios.get(`http://localhost:5003/api/restaurants/menu/${id}`),
        ]);
            ...
            <div key={item._id} className="menu-item-card">
              ...
              <div className="menu-item-content">
                ...
                <textarea
                  ...
                  onChange={e => handleChange(item._id, 'note', e.target.value)}
                />
